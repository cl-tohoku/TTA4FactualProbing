...
def main():
    ...
    single_graph('v2.11d.flan-small.uncased', axes[0,0])
    single_graph('v2.11d.flan.uncased', axes[0,1])
    single_graph('v2.11d.t03b', axes[1,0])
    ...
    plt.savefig('analysis/img/prec_conf/{}.pdf'.format('others'), transparent=True)
    return 0
